...
mod_info_zaupfeast=(MOD "zaupfeast" "ZaupFeast" "${zaupfeast_latestlink}" "ZaupFeast.zip" "0" "LowercaseOff" "${systemdir}/Servers/untserver/Rocket/Plugins" "OVERWRITE" "ENGINES" "Unturned;" "NOTGAMES" "https://github.com/RocketModPlugins/ZaupFeast" "Feast event plugin for Unturned servers" "0" "0")
